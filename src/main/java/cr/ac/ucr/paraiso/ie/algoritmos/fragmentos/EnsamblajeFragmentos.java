package cr.ac.ucr.paraiso.ie.algoritmos.fragmentos;import cr.ac.ucr.paraiso.ie.algoritmos.grafos.Grafo;
...
//        StringBuilder textoReconstruido = new StringBuilder();
        ...
        if (fragmentos != null && !fragmentos.isEmpty()) {
            // Ordenar fragmentos en base a su posiciÃ³n inicial
